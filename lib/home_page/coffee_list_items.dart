...
Widget coffeListitem(
    ...
    required int id}) {
  FavouritListProvider favlist = context.read<FavouritListProvider>();
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(title, style: BoldTextStyle.bold16, maxLines: 1),
